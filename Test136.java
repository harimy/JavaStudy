...
○ 캐릭터 셋(CharacterSet)
   ...
   - 유니코드(unicode)
     국제 표준으로 제정된 2바이트계의 만국 공통의 
	 국제 문자부호 체계(UCS: Universal Code System)를 말한다.
	 애플컴퓨터, IBM, 마이크로소프트 등이 컨소시엄으로 설립한 유니코드(unicode)가
	 1990년에 첫 버전을 발표하였고, 
   ...
   - UTF-8 과 UTF-16
	 ...
	 ·UTF-16(16bit UCS Transformation Format)
       자바의 기본 코드. 
	   자바에서는 문자 하나를 저장하면 바이트 수는 영문자든 한글문자든 2바이트를 차지하게 된다.
...
○ 문자 코드의 종류
   ...
   - EUC-KR(MS949)
     Bell-Laboratories 에서 유닉스 상에서 영문자 이외의 문자를 지원하기 위해 제안한
	 확장 유닉스 코드(Extend UNIX Code) 중 한글 인코딩 방식.
...
public class Test136
{
	public static void main(String[] args) //throws UnsupportedEncodingException
	{
		...
		try
		{
			...
			// String 객체로 생성
			//System.out.println("value1 : " + new String(바이트배열));
			...
			※ EUC-KR 을 UTF-8 로 변환한다고 위와 같이 코딩을 해버리면
			   ...
			   EUC-KR 이든 UTF-8 이든
			   어떠한 바이트 배열로 읽어오든 깨져 있는 것을 확인할 수 있다.
