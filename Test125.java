...
○ Wrapper 클래스
   ...
   2. 기본 자료형인
      ...
      ex) java.lang.Integer 클래스
		  ...
		  정수를 다루는데 필요한 상수나 메소드, 
		  진수 변환 등에 필요한 메소드 등을 포함하고 있다.
...
public class Test125
{
	public static void main(String[] args)
	{
		...
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 10
		// Integer 에서 toString() 메소드를 Overriding(재정의) 해서 Object 의 toString() 메소드가 덮어쓰여진 상태.
		// 따라서 d.toString은 Object의 toString이지만, Object의 원본 toString이 아니라 Integer가 덮어쓴 toString이다. 

		d = new Double(12.345);	//-- 업 캐스팅
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 12.345

		d = 10;			// Object d = 10;	//-- 오토 박싱
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 10
