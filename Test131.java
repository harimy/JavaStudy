...
○ String 객체의 생성 및 특징
   ...
   하지만 『=』 대입 연산자만을 사용하여 
   문자열 상수를 지정하는 방법을 통해 객체를 생성하는 경우와
...
public class Test131
{
	public static void main(String[] args)
	{
		...
		//-- 이와 같은 경우(line 92 ~ 97 까지 s2만 봤을 때) 
		//   s2 가 참조한 "seoul" 이 저장된 영역은
		//   『s2 += "korea"』가 수행되는 시점에서
		//   가비지 컬렉션의 대상이 되며 (s1이 참조하고 있는 경우에는 가비지 컬렉션의 대상이 되지 않음)
